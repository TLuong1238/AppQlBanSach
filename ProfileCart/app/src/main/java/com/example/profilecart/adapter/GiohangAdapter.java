package com.example.profilecart.adapter;
...
public class GiohangAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Picasso.with(context).load(giohang.getHinhanh()).placeholder(R.drawable.user_male).error(R.drawable.no_image).into(viewHolder.imgSanpham);
        ...
        viewHolder.btnCong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                com.example.profilecart.activity.GioHang.Tongtien();
                if(soluongmoinhat>9){
