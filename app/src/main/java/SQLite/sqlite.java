...
public class sqlite extends SQLiteOpenHelper {
    ...
    public void updateDB(){
        String table_gioHang = "create table if not exists gio_hang(id_giohang INTEGER PRIMARY KEY AUTOINCREMENT, id_taikhoan INTEGER null, tensach TEXT, hinhanh BLOB null, soluong INTEGER default 1, gia INTEGER);";
